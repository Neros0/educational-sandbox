...
contract MathChallenge20 {
    ...
    string public problem = "What is 2^8 + 10^1 - 4^3 + 3 + 3 + 1 + 1 + 6 + 2 + 2?";
    ...
    uint256 public immutable correctAnswer = 221; // 256 + 10 - 64 + 3 + 3 + 1 + 1 + 6 + 2 + 2 = 221
