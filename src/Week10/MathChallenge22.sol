...
contract MathChallenge22 {
    ...
    string public problem = "What is 2^8 + 10^1 - 4^3 + 5 + 3 + 1 + 1 + 6 + 2 + 2 + 2 + 2?";
    ...
    uint256 public immutable correctAnswer = 227; // 256 + 10 - 64 + 5 + 3 + 1 + 1 + 6 + 2 + 2 + 2 + 2= 227
